// How it works, Feature grid, Logo wall, FAQ, CTA, Footer.
          ...
          {t.steps.map((s, i) => (
            <Reveal key={s.k} delay={i * 80}>
              ...
              >
                ...
                <div
                  className="display"
                  style={{ fontSize: 22, fontWeight: 600, letterSpacing: "-0.01em", marginBottom: 8 }}
                >
                  {s.t}
                </div>
          ...
          {t.items.map((item, i) => (
            <Reveal key={i} delay={(i % 3) * 60}>
              ...
              >
                ...
                <div className="display" style={{ fontSize: 17, fontWeight: 600, marginBottom: 6 }}>
                  {item.t}
                </div>
...
function LogoWall({ lang }) {
  const label = COPY[lang].logos;
  // Placeholder wordmarks — intentionally neutral so we don't imply real customers.
    ...
    <section id="cta" style={{ padding: "80px 0 110px" }}>
      <Container>
        <Reveal>
          ...
          >
            {/* subtle accent dot flourish, reference-style */}
            <div
              style={{
                position: "absolute",
                top: 28,
            ...
            <p style={{ maxWidth: 560, margin: "0 auto 26px", fontSize: 16, lineHeight: 1.55, color: "rgba(255,255,255,0.7)" }}>
              {t.body}
            </p>
  ...
  return (
    <footer style={{ borderTop: "1px solid var(--line)", padding: "44px 0 40px", background: "var(--bg)" }}>
      <Container>
          ...
          {t.cols.map((c) => (
            <div key={c.h}>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
                {c.l.map((x) => (
                  <li key={x}>
                    <a href="#" style={{ color: "var(--ink-2)", textDecoration: "none", fontSize: 14 }}>
                      {x}
                    </a>
                  </li>
                ))}
        ...
        >
          <div>{t.rights}</div>
          <div className="mono" style={{ letterSpacing: "0.1em", textTransform: "uppercase" }}>
            v3 · capture.so
          </div>
        </div>
      </Container>
...
Object.assign(window, { HowItWorks, Features, LogoWall, FAQ, CTA, Footer });
